module.exports = {
	...
	execute(msg, args, embed) {
		...
		embed.setTitle('Note: A user just suggested a check-in')
			...
			.addField( ':raised_hand:', 'If you don’t know how you feel about what was said or don’t care', true )
			.addField( ':thumbsdown:', '(In RP) If you think what was said is worth revising OR (In chat) if you would like to bring the topic of conversation to a close', true )
