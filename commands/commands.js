module.exports = {
	...
	execute(msg, args, embed) {
		...
		embed.setTitle( 'List of directives' )
			...
			.addField( '!downtime <activity (optional)>', '(Work in progress) This directive returns an overview of the various activities users can undertake between missions.' )
